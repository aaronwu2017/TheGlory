# EXHIBIT C-8: Bitcoin ETF vs Binance Spot Price & Volume Analysis
...
- **Conversion Ratio**: 1759.43 (Binance Spot / IBIT, based on US morning 09:30-12:00 ET)

**Volatility Analysis**
- **Global Volatility Multiplier** (15-min window, 9,569 samples):
  - Average: 0.96x (Binance Spot volatility typically 96% of IBIT)
  - Median: 0.96x

**Historical Anomaly Detection**
(15m & 1h windows | Binance Spot Vol > 1% & Magnitude > 1.5x IBIT)

Found **3 significant independent events**:

| Time Window | Timestamp | Binance Spot Change | IBIT Change | Multiplier | Type |
|-------------|-----------|---------------------|-------------|------------|------|
...
- **Binance Spot Max Drop**: -29.55% (114,425.7 → 80,616.26 @ 2025-11-21 12:25:00)

**October 10, 2025 Incident Analysis** (20:30:00 - 22:30:00 UTC)
- **IBIT Max Drop**: -7.97% (66.27 → 60.99 @ 21:25:00)
- **Binance Spot Max Drop**: -12.78% (116,799.19 → 101,877.69 @ 21:20:00)
- **Theoretical Binance Spot Low** (based on morning ratio): $107,307.57
- **Actual Binance Spot Low**: $101,877.69
...
- **Conversion Ratio**: 1145.47 (Binance Spot / FBTC, based on US morning 09:30-12:00 ET)

**Volatility Analysis**
- **Global Volatility Multiplier** (15-min window, 7,507 samples):
  - Average: 0.97x (Binance Spot volatility typically 97% of FBTC)
  - Median: 0.96x

**Historical Anomaly Detection**
(15m & 1h windows | Binance Spot Vol > 1% & Magnitude > 1.5x FBTC)

Found **5 significant independent events**:

| Time Window | Timestamp | Binance Spot Change | FBTC Change | Multiplier | Type |
|-------------|-----------|---------------------|-------------|------------|------|
...
- **Binance Spot Max Drop**: -29.65% (114,590.0 → 80,616.26 @ 2025-11-21 12:25:00)

**October 10, 2025 Incident Analysis** (20:30:00 - 22:30:00 UTC)
- **FBTC Max Drop**: -8.57% (101.84 → 93.11 @ 21:25:00)
- **Binance Spot Max Drop**: -12.78% (116,799.19 → 101,877.69 @ 21:20:00)
- **Theoretical Binance Spot Low** (based on morning ratio): $106,654.88
- **Actual Binance Spot Low**: $101,877.69
...
### 2.1 Daily Trading Volume: Binance Spot BTC vs IBIT

| Date | Binance Spot Open | IBIT Open | Ratio (BTC/Share) | Binance Spot Vol (BTC) | IBIT Vol (Equiv BTC) | Binance Spot/IBIT |
|------|-------------------|-----------|-------------------|------------------------|----------------------|-------------------|
...
**Average Volume Ratio**: ~0.16x (Binance Spot volume approximately 16% of IBIT volume equivalent)
...
- Under normal conditions, Binance Spot volatility tracks ETF volatility closely (~0.96-0.97x multiplier)
- October 10, 2025 incident shows **1.6-1.8x anomalous volatility amplification** on Binance Spot

### 3.2 Price Deviations
- **IBIT**: Binance Spot dropped 5.06% below theoretical price during incident
- **FBTC**: Binance Spot dropped 4.48% below theoretical price during incident
- ETF prices maintained stability while Binance Spot experienced extreme downward pressure

### 3.3 Market Dominance
- IBIT trading volume significantly exceeds Binance Spot BTC volume (6.25x average)
- IBIT holds more BTC than Binance Spot (770k vs 636k BTC)
