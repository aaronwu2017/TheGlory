...
# Exchange-specific SOL/USD symbol mapping
SYMBOL_MAP = {
    "binance": ["SOLUSDT"],
    "coinbase": ["SOL-USD"],
    "gemini": ["SOLUSD"],
...
def download_spot_trades():
    """
    Downloads SOL spot trading data across major exchanges for 2025-10-10.
    """
    ...
    print("Starting SOL spot trade data downloads...")
    ...
    for exchange in EXCHANGES:
        exchange_symbols = SYMBOL_MAP.get(exchange, ["SOLUSDT"])
        success = 0
...
def compare_prices():
    """
    Compare minimum prices across exchanges for SOL.
    """
    script_dir = os.path.dirname(os.path.abspath(__file__))
    download_dir = script_dir

    print("\n--- Price Comparison Analysis (SOL) ---")
