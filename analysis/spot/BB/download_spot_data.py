...
# BB (BounceBit) may not be available on Coinbase/Gemini
...
def download_spot_trades():
    ...
    print(f"Starting BB spot trade data downloads...")
    print(f"Note: BB (BounceBit) may not be available on Coinbase")
