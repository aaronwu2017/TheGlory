...
# Note: Binance spot uses BONK (not 1000BONK like futures)
SYMBOL_MAP = {
    "binance": ["BONKUSDT"],
    "coinbase": ["BONK-USD"],
    "gemini": ["BONKUSD"],
...
def download_spot_trades():
    ...
    print(f"Starting BONK spot trade data downloads...")
    print(f"Note: Binance uses 1000BONK, Coinbase uses BONK (multiply by 1000)")
