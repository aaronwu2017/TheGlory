...
# Note: Binance spot uses PEPE (not 1000PEPE like futures)
SYMBOL_MAP = {
    "binance": ["PEPEUSDT"],
    "coinbase": ["PEPE-USD"],
    "gemini": ["PEPEUSD"],
...
def download_spot_trades():
    ...
    print(f"Starting PEPE spot trade data downloads...")
    print(f"Note: Binance uses 1000PEPE, Coinbase uses PEPE (multiply by 1000)")
