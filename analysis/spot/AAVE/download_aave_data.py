...
# Exchange-specific AAVE/USD symbol mapping
SYMBOL_MAP = {
    "binance": ["AAVEUSDT"],
    "coinbase": ["AAVE-USD"],
    "gemini": ["AAVEUSD"],
...
def download_spot_trades():
    """
    Downloads AAVE spot trading data across major exchanges for 2025-10-10.
    """
    ...
    print("Starting AAVE spot trade data downloads...")
    ...
    for exchange in EXCHANGES:
        exchange_symbols = SYMBOL_MAP.get(exchange, ["AAVEUSDT"])
        success = 0
...
def compare_prices():
    """
    Compare minimum prices across exchanges for AAVE.
    """
    script_dir = os.path.dirname(os.path.abspath(__file__))
    download_dir = script_dir

    print("\n--- Price Comparison Analysis (AAVE) ---")
